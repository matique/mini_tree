...
class Create<Model>Trees < ActiveRecord::Migration[8.0]                         â
  def change                                                                 â
    create_table :<model>_trees do |t|                                          â
      t.string :legend                                                       â
      t.integer :parent_id, index: true                                      â
      t.integer :position, null: false, default: 0                           â
      t.boolean :collapsed, default: false                                   â
      t.string :kind                                                         â
                                                                             â
      t.timestamps                                                           â
    end                                                                      â
    # add_foreign_key :items, :items, column: :parent_id                     â
  end                                                                        â
end                                                                          â
~~~
